...
user in an INI file next to HDDLLFPortable.exe called HDDLLFPortable.ini.
...
copy AppNamePortable.ini from this directory to HDDLLFPortable.ini next to
HDDLLFPortable.exe. The options in the INI file are as follows:
